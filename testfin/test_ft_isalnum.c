...
/*                                                   +#+                      */
/*   Created: 2020/11/12 13:40:28 by jjacobs       #+#    #+#                 */
/*   Updated: 2020/11/12 13:54:37 by jjacobs       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv)
{
	...
	if (ft == 1)
	{
		printf("isalnum(int = %i)? %i\n", INT_MAX, ft_isalnum(INT_MAX));
		printf("isalnum(int = %i)? %i\n", INT_MIN, ft_isalnum(INT_MIN));
	}
	if (ft == 0)
	{
		printf("isalnum(int = %i)? %i\n", INT_MAX, isalnum(INT_MAX));
	...
	if (ft == 1)
	{
	//	printf("isalnum(int = %i)? %i\n", INT_MAX + 100, ft_isalnum(INT_MAX + 100));
	//	printf("isalnum(int = %i)? %i\n", NULL, ft_isalnum(NULL));
	}
	if (ft == 0)
	{
	//	printf("isalnum(int = %i)? %i\n", INT_MAX + 100, isalnum(INT_MAX + 100));
	//	printf("isalnum(int = %i)? %i\n", NULL, isalnum(NULL));
	}
}
